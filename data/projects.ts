...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: {
      ko: 'WigPlugin은 Claude Code 마켓플레이스에 공개된 AI 개발 워크플로우 플러그인입니다(15★). PRD 생성, AI 코드 리뷰, 병렬 멀티에이전트 빌드 등 개발 프로세스를 자동화합니다.',
      en: 'AI development workflow plugin on Claude Code marketplace (15★). Automates PRD generation, AI code review, and parallel multi-agent builds.',
      ja: 'Claude Codeマーケットプレイス公開のAI開発ワークフロープラグイン（15★）。PRD生成、AIコードレビュー、並列マルチエージェントビルドを自動化。',
    },
    badges: [{ label: 'Active', variant: 'active' }, { label: '15★', variant: 'award' }],
